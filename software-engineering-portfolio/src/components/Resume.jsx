  ...
  return (
    <div className="resume-content">
        ...
        <p>
          ...
          creating products that are sustainable over time. I have a background
          in meeting customer and employer needs under pressure and am driven by
          a passion for expanding my knowledge and skills. I thrive on solving
          ...
          committed to improving user experiences through approachable
          navigation in websites and software, ensuring inclusivity and
          accessibility for all. Moreover, I aim to provide user-friendly and
          effective results by incorporating functionality and aesthetics.
        </p>
